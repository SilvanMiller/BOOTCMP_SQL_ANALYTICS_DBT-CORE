...
--SELECT * FROM products WHERE product_name BETWEEN 'Carnarvon Tigers' AND 'Mozzarella di Giovanni' ORDER BY product_name;--(selects todos os produtos entre 'Carnarvon Tigers' e 'Mozzarella di Giovanni', entre C e M)
